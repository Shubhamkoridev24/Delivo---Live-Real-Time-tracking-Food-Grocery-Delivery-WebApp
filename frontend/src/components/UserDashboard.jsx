...
{searchItems && searchItems.length > 0 && (
  <div className="w-full max-w-6xl flex flex-col gap-5 items-start 
      p-5 bg-white shadow-md rounded-2xl mt-[100px]">

    <h1 className="text-gray-900 text-2xl sm:text-2xl font-semibold border-b
...
<div className="w-full max-w-6xl flex flex-col gap-5 items-start p-[10px] mt-[90px]">
